...
$messagesec",
    ...
    'reply_markup'=>json_encode(['inline_keyboard' => [
        [
          ['text' => "💠 Created By 💠", 'url' => "t.me/hiirocchi"]
        ],
        [
          ['text' => "💎 Source Code 💎", 'url' => "t.me/hiirocchi"]
        ],
...
<b>/ss - Stripe [Auth] (Coming Soon)</b>
<b>/sm - Stripe [Merchant] (Coming Soon)</b>
<b>/schk - User Stripe Merchant [Needs SK] (Coming Soon)</b>
<b>/apikey sk_live_xxx - Add SK Key for /schk gate (Coming Soon)</b>
<b>/myapikey - View the added SK Key for /schk gate (Coming Soon)</b>
